...
final class S_Float implements SchemaInterface
{
    use CantBeUsedAsArrayKey, CloneSchemaWithNewProps;

    public function __construct(
        public readonly float|null $gt = null,
        public readonly float|null $gte = null,
        public readonly float|null $lt = null,
        public readonly float|null $lte = null,
